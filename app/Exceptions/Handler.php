...
class Handler extends ExceptionHandler
{
    ...
    protected  $exceptionMap = [
        ModelNotFoundException::class => [
            'code' => 404,
            'message' => 'Could not find what you were looking for. Or Resource Model not found!!',
            'adaptMessage' => false,
        ],

        NotFoundHttpException::class => [
            'code' => 404,
            'message' => 'Could not find what you were looking for. Or Resource not found!!',
            'adaptMessage' => false,
        ],
        ...
        \InvalidArgumentException::class => [
            'code' => 400,
            'message' => 'Bad Request. You provided some invalid input value',
            'adaptMessage' => true,
        ],
    ];
